...
namespace WULib.Core.Extensions
{
    ...
    public class RandomIdGenerator
    {
        ...
        readonly ulong MersenePrime = 0x7FFFFFFF;           // M = 2^31 -1 = 2,147,483,647 (Mersenne prime M31)
        readonly ulong PrimeRoot = 0x41A7;                  // A = 16807 (a primitive root modulo M31)
        readonly ulong Quotient = 0x1F31D;                  // Q = 127773 = M / A (to avoid overflow on A * seed)
        readonly ulong Rest = 0xB14;                        // R = 2836 = M % A (to avoid overflow on A * seed)
